                ...
                <div className="row">
                  <center>
                    <p className="mx-sm-auto text-sm-center">
                      Hey Astrologer {user.firstName}, Welcome to Dreshkan !<br></br>
                      For working with us on providing consultations via chat , voice and video ,
              ...
              <div className="col-sm-8 my-4  ">
                ...
                <div className="row">
                  ...
                  <div className={"card text-black border-warning mb-3 m-3 "+`${styles.profileCard}`} >
                    ...
                    <Image src={user?.profilePicLink ? user?.profilePicLink : "/images/loading.svg"} width="200" height="200" />
                    </div>
                  <div className="card-body">
                    <h5 className="card-title">{"Astrologer "+user.firstName + " " + user.secondName}</h5>
                    <p className="card-text"><b>Address : </b>{user.address}<br/><b> DOB : </b>{user?.dob?.toDate()?.toDateString()}</p>
                  </div>
